...
public class RemedialAddPage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RemedialAddPage frame = new RemedialAddPage();
	...
	public RemedialAddPage() {
		...
		JButton button = new JButton("\u6DFB\u52A0\u7F3A\u52E4");
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(RemedialOperate.isAdd(values)) {
					Object[] options = { "确认"}; 
					JOptionPane.showOptionDialog(null, "添加成功！", "警告", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]); 
				}
				else {
					Object[] options = { "确认"}; 
					JOptionPane.showOptionDialog(null, "添加失败！", "警告", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]); 
				}
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					System.err.println(new Date());
